...
/**
 * The last panel on pi-loft, and therefore the one its wiring is copied from.
 *
 * Its pins and its clock differ from both of the others', so a form that
 * pre-filled from the *first* screen, or from the schema's defaults, shows
 * different numbers than this one and the assertions below say which.
 */
const KITCHEN = panel({
  id: 11,
  name: "Kitchen",
